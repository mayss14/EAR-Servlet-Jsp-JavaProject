...
<header>
	...
	<h1 class="text-center p-2 bg-success text-light">Ajouter Utilisateur</h1>
		...
		<form action="User">
			...
			<div class="mx-2">
				<label for="mdp" class="form-label">Mot de passe :</label> <input
					type="text" class="form-control" id="mdp" name="mdp">
			</div>
			
			
			<button type="submit" class="btn btn-success btn-sm m-2 p-2">Ajouter
				Utilisateur</button>
		</form>
